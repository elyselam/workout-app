...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `workoutapp`.`exercise_name_table` (
  `exercise_id` INT(11) NOT NULL AUTO_INCREMENT,
  `exercise_name` VARCHAR(255) DEFAULT NULL,
  `routine_day` INT(11) NOT NULL,
  ...
  KEY `fk_routine` (`routine_day`),
  CONSTRAINT `fk_routine` FOREIGN KEY (`routine_day`) REFERENCES `routine_table`(`routine_id`)
) 
ENGINE=InnoDB
AUTO_INCREMENT = 1;
